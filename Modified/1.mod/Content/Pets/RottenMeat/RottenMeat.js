...
export class RottenMeat extends ModItem {
    constructor() {
        super();
    ...
    SetDefaults() {
        ...
        this.Item.shoot = ModProjectile.getTypeByName('RottenMeatPro');
        this.Item.buffType = ModBuff.getTypeByName('RottenMeatBuff');
    }
