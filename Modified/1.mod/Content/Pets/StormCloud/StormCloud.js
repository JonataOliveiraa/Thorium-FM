...
export class StormCloud extends ModItem {
    constructor() {
        super();
    ...
    SetDefaults() {
        ...
        this.Item.shoot = ModProjectile.getTypeByName('StormCloudPro');
        this.Item.buffType = ModBuff.getTypeByName('StormCloudBuff');
    }
