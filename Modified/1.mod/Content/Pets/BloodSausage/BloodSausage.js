...
export class BloodSausage extends ModItem {
    constructor() {
        super();
    ...
    SetDefaults() {
        ...
        this.Item.shoot = ModProjectile.getTypeByName('BloodSausagePro');
        this.Item.buffType = ModBuff.getTypeByName('BloodSausageBuff');
    }
