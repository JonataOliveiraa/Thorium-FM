...
export class GorgedEye extends ModNPC {
    constructor() {
        super();
    ...
    SetDefaults() {
        this.NPC.width = 35;
        this.NPC.height = 17;
        this.NPC.aiStyle = Terraria.ID.NPCAIStyleID.DemonEye;
        this.NPC.damage = 10;
        this.NPC.defense = 10;
        this.NPC.lifeMax = 15;
        ...
        this.AnimationType = Terraria.ID.NPCID.DemonEye
    }
    ...
    OnHitPlayer(npc, player, target, damage, crit) {
        ...
        if(Math.random() > 0.8) player['void AddBuff(int type, int time, bool fromNetPvP)'](buffType, duration, false);
    }
    ...
    SetBestiary(database, bestiaryEntry) {
        ...
        FlavorText._key = ModLocalization.Translate('Bestiary.GorgedEye');
