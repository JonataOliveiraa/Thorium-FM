...
function mountType() {
    if (_mountType <= 0) _mountType = ModMount.getTypeByName('MassiveCrabClawMount') ?? 0;
    return _mountType;
}

export class MassiveCrabClaw extends ModItem {
    constructor() {
        super();
    ...
    SetDefaults() {
        ...
        this.Item.value = Terraria.Item.sellPrice(0, 2, 40, 0);
