...
const DidgeridooSound = BardItemSound.Saxophone;

export class Didgeridoo extends ModBardItem {
    constructor() {
        super();
    ...
    SetDefaults() {
        this.Item.shoot = ModProjectile.getTypeByName('DidgeridooPro');
        this.Item.shootSpeed = 4;

        this.SetWeaponValues(14, 5, 4);
    ...
    UseItem(item, player) {
        ...
        if (player.itemAnimation === player.itemAnimationMax) {
            Effects.PlaySound(DidgeridooSound, player.Center.X, player.Center.Y, 1, 0.3, 1.1);
            Empowerments.Apply(player, "AttackSpeed", 1);
        }
        return true;
    }
