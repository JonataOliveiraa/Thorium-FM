...
export class EnchantedCane extends ModItem {
    constructor() {
        super();
    ...
    SetDefaults() {
        ...
        this.Item.buffType = ModBuff.getTypeByName('EnchantedCaneBuff');
        this.Item.shoot = ModProjectile.getTypeByName('EnchantedCanePro');
    }
