...
export class ShadeWoodTambourine extends ModBardItem {
    constructor() {
        super();
    ...
    SetDefaults() {
        ...
        if (_proType === -1) _proType = ModProjectile.getTypeByName('ShadeWoodTambourinePro') ?? -2;
    ...
    Shoot(item, player, position, velocity, type, damage, knockBack) {
        ...
        if (_burstType === -1) _burstType = ModProjectile.getTypeByName('ShadeWoodTambourinePro2') ?? -2;
    ...
    AddRecipes() {
        this.CreateRecipe(1)
            ...
            .AddIngredient(Terraria.ID.ItemID.Shadewood, 10)
