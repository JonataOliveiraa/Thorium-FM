...
export class GoldBugleHorn extends ModBardItem {
    constructor() {
        super();
    ...
    SetDefaults() {
        this.Item.shoot = ModProjectile.getTypeByName('GoldBugleHornPro');
        this.Item.shootSpeed = 2.5;

        this.SetWeaponValues(11, 4, 4);
        this.SetDefaultWeaponStyle(36, true); // useTime e useAnimation = 36
    ...
    Shoot(item, player, position, velocity, type, damage, knockBack) {
        ...
        return false; // impede o disparo padrão
    }
