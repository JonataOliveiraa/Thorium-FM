...
export class IcyHeadgear extends ModItem {
  ...
  UpdateArmorSet(item, player) {
    const IcyPlayer = ModPlayer.getByName('gPlayer')
    IcyPlayer.IcyArmorBuff = true

    if (!IcyPlayer.IcyArmorPro && player.whoAmI === Terraria.Main.myPlayer) {
