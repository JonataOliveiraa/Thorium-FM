...
export class SkeletonRepellent extends ModItem {
    constructor() {
        super();
        this.Texture = "Items/Potions/" + this.constructor.name;
    }
    ...
    SetDefaults() {
        ...
        this.Item.buffType = ModBuff.getTypeByName("RepellentSkeletonsBuff");
