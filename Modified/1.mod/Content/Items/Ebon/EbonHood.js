...
import { EbonLeggings } from './EbonLeggings.js';

export class EbonHood extends ModItem {
    constructor() {
        super();
    ...
    AddArmorSets() {
        this.CreateArmorSet(
            this.Type,
            ModItem.getTypeByName('EbonCloak'),
            ModItem.getTypeByName('EbonLeggings'),
            ModLocalization.getTranslationArmorSetBonus('Ebon')
        );
    }
    ...
    UpdateArmorSet(item, player) {
        ThoriumPlayer.RadiantCorruptionActive = true
    }
